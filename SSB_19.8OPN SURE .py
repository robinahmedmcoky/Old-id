...
_____       _     _       
 ...
 |_|  \_\___/|_.__/|_|_| |_| 
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            Muhammad ROBIN
\033[1;37m Facebook:         MOHAMMAD ROBIN 
\033[1;37m Github  :            robinahmedcoky 
...
def cutter():
    ...
    print(" ")
    sarfraz = input('Saving Put File Name:')
    os.system('touch ' +robin)
    os.system('sort -r '+ssb+' | uniq > '+robin)
    os.system('clear')
    print(logo)
    print("Removed Successful From File: " + ssb )
    print("New File Saved:" + robin )
    print(47*'-')
    input(f"{S} Press Enter To Back SSB Menu ")
    SSB(allkey)       
    
def removef():
        os.system('robin-oky');print(f'\n{R}Files Removed Successfully ...')
        SSB(allkey)            
